...
class UserInterface():
    ...
    def make_frame_left(self):
        self.frame_left = Frame(self.window, bg='#FFC0CB', bd=10, relief='groove', width=self.window_width * 0.3, height=self.window_height)
        self.frame_left.pack(side='left')
        self.frame_left.pack_propagate(0)
        btn = Button(self.frame_left, text='HHHH')
        btn.place(x=50, y=100, anchor='nw')
        

    def make_frame2(self):
        self.frame2 = Frame(self.window, bg='#FFF0F5', bd=10, relief='groove', width=self.window_width * 0.7, height=self.window_height)
